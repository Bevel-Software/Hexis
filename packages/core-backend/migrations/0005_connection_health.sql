...
ALTER TABLE "connection_health" ADD CONSTRAINT "connection_health_status" CHECK ("connection_health"."status" IN ('ok', 'failed', 'unverifiable'));--> statement-breakpoint
CREATE INDEX "connection_health_by_user" ON "connection_health" USING btree ("user_id");--> statement-breakpoint
