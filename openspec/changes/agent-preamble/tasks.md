...
- [ ] 9.3 Manual: connect through `hexis-mcp` and confirm the same text arrives; point `hexis-mcp` at a config stub without the flag and confirm it starts with the one log line
